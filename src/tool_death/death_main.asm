...
manage_toggles:
incsrc "src/tool_death/death_manage_toggles.asm"
...
CMP #$06
BNE stage_13_check
incsrc "src/tool_death/death_stage_06.asm"

stage_13_check:
CMP #$0D
BNE stage_14_check
incsrc "src/tool_death/death_stage_13.asm"
...
incsrc "src/tool_death/death_stage_14.asm"

stage_17_check:
LDA {currstage}
CMP #$11
BNE done
incsrc "src/tool_death/death_stage_17.asm"
...
death_print_status:
incsrc "src/tool_death/death_print_status.asm"
