...
transfer_room_time:
incsrc "src/tool_timer/timer_transfer_room_time.asm"
increment_timer:
incsrc "src/tool_timer/timer_increment_timer.asm"
print_timer:
incsrc "src/tool_timer/timer_print_timer.asm"
print_static_timers:
incsrc "src/tool_timer/timer_print_static_timers.asm"
cap_lag_counter:
incsrc "src/tool_timer/timer_cap_lag_counter.asm"
print_lag_counter:
incsrc "src/tool_timer/timer_print_lag_counter.asm"